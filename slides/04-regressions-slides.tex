...
\begin{verbatim}
##                Estimate       Q2.5       Q97.5
## b_Intercept     5.11844     5.1058     5.13064
## b_c_trial       0.00052     0.0004     0.00065
## sigma           0.12330     0.1147     0.13295
## lp__        -1603.65601 -1606.7664 -1602.27805
\end{verbatim}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{correct =} \KeywordTok{if_else}\NormalTok{(response_category }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{select}\NormalTok{(subject, set_size, c_set_size, correct, trial)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# We use as.numeric to get zeros and ones rather than FALSE and TRUE}
\KeywordTok{rbernoulli}\NormalTok{(}\DataTypeTok{n =} \DecValTok{10}\NormalTok{, }\DataTypeTok{p =} \FloatTok{0.5}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{04-regressions-slides_files/figure-beamer/logisticfun-1.pdf}
...
\begin{figure}
\includegraphics[width=0.45\linewidth]{04-regressions-slides_files/figure-beamer/logoddspriorsf-1} \includegraphics[width=0.45\linewidth]{04-regressions-slides_files/figure-beamer/logoddspriorsf-2} \caption{Prior for \(\alpha \sim Normal(0, 4)\) in log-odds and in probability space.}\label{fig:logoddspriorsf}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.45\linewidth]{04-regressions-slides_files/figure-beamer/logoddspriorsf2-1} \includegraphics[width=0.45\linewidth]{04-regressions-slides_files/figure-beamer/logoddspriorsf2-2} \caption{Prior for \(\alpha \sim Normal(0, 1.5)\) in log-odds and in probability space.}\label{fig:logoddspriorsf2}
\end{figure}
...
Edited version of the earlier \texttt{normal\_predictive\_distribution\_fast}:
...
\NormalTok{                                N_obs) \{}
    \KeywordTok{map2_dfr}\NormalTok{(alpha_samples, beta_samples,}
             \ControlFlowTok{function}\NormalTok{(alpha, beta) \{}
                 \KeywordTok{tibble}\NormalTok{(}\DataTypeTok{set_size =}\NormalTok{ set_size,}
...
\NormalTok{    beta_samples <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{1000}\NormalTok{, }\DecValTok{0}\NormalTok{, sd)}
    \KeywordTok{logistic_model_pred}\NormalTok{(}\DataTypeTok{alpha_samples =}\NormalTok{ alpha_samples,}
                        ...
                        \DataTypeTok{N_obs =}\NormalTok{ N_obs) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(mean_accuracy <-}\StringTok{ }\NormalTok{prior_pred }\OperatorTok{%>%}
\StringTok{   }\KeywordTok{group_by}\NormalTok{(prior_beta_sd, iter, set_size) }\OperatorTok{%>%}\StringTok{ }
...
\StringTok{  }\KeywordTok{facet_grid}\NormalTok{(set_size }\OperatorTok{~}\StringTok{ }\NormalTok{prior)}
\end{Highlighting}
\end{Shaded}

\includegraphics{04-regressions-slides_files/figure-beamer/priors4beta-1.pdf}
...
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_grid}\NormalTok{(diffsize }\OperatorTok{~}\StringTok{ }\NormalTok{prior)}
\end{Highlighting}
\end{Shaded}

\includegraphics{04-regressions-slides_files/figure-beamer/priors4beta2-1.pdf}
...
\includegraphics{04-regressions-slides_files/figure-beamer/unnamed-chunk-34-1.pdf}
...
\KeywordTok{c}\NormalTok{(}\DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(av_accuracy), }\KeywordTok{quantile}\NormalTok{(av_accuracy, }\KeywordTok{c}\NormalTok{(.}\DecValTok{025}\NormalTok{, }\FloatTok{.975}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{effect_av_set_size <-}\StringTok{ }\KeywordTok{plogis}\NormalTok{(alpha_samples) }\OperatorTok{-}\StringTok{ }\KeywordTok{plogis}\NormalTok{(alpha_samples }\OperatorTok{-}\StringTok{ }\NormalTok{beta_samples)}
\KeywordTok{c}\NormalTok{(}\DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(effect_av_set_size), }\KeywordTok{quantile}\NormalTok{(effect_av_set_size, }\KeywordTok{c}\NormalTok{(.}\DecValTok{025}\NormalTok{, }\FloatTok{.975}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{set4 <-}\StringTok{ }\DecValTok{4} \OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(df_recall_data}\OperatorTok{$}\NormalTok{set_size)}
\NormalTok{set2 <-}\StringTok{ }\DecValTok{2} \OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(df_recall_data}\OperatorTok{$}\NormalTok{set_size)}
\NormalTok{effect_4m2 <-}\StringTok{ }\KeywordTok{plogis}\NormalTok{(alpha_samples }\OperatorTok{+}\StringTok{ }\NormalTok{set4 }\OperatorTok{*}\StringTok{ }\NormalTok{beta_samples) }\OperatorTok{-}
\StringTok{  }\KeywordTok{plogis}\NormalTok{(alpha_samples }\OperatorTok{+}\StringTok{ }\NormalTok{set2 }\OperatorTok{*}\StringTok{ }\NormalTok{beta_samples)}
\KeywordTok{c}\NormalTok{(}\DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(effect_4m2), }\KeywordTok{quantile}\NormalTok{(effect_4m2, }\KeywordTok{c}\NormalTok{(.}\DecValTok{025}\NormalTok{, }\FloatTok{.975}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df_recall_pred_ext <-}\StringTok{ }\KeywordTok{posterior_predict}\NormalTok{(fit_recall,}
  ...
  \DataTypeTok{nsamples =} \DecValTok{1000}
...
\includegraphics{04-regressions-slides_files/figure-beamer/postpredsum2-1.pdf}
